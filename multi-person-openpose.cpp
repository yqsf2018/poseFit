...
int main(int argc,char** argv) {
	...
	std::cout << "detectedKeypoints:" << detectedKeypoints << std::endl;
	std::cout << "keyPointsList:" << keyPointsList << std::endl;
	std::cout << "personwiseKeypoints:" << personwiseKeypoints << std::endl;
